...
public class EscrituraInterna extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if (v == btnMas){
            ...
            if (miMemoria.escribirInterna(NOMBRE_FICHERO, texto, false, "UTF-8")) {
                txvPropiedades.setText(miMemoria.mostrarPropiedadesInterna(NOMBRE_FICHERO));
            } else
                txvPropiedades.setText("Error al escribir el archivo en memoria interna");
        }
    }
}
